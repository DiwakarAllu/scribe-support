...
public class UploadPdfActivity extends AppCompatActivity {
    ...
    private void uploadPdf() {
        ...
        StorageReference imagesRef = storageRef.child("Study Material");
        StorageReference reference = storageRef.child("Study Material/"+pdfName+"-"+System.currentTimeMillis()+".pdf");
    ...
    private void uploadData(String valueOf) {
        String uniqueKey = databaseReference.child("Study Material").push().getKey();

        HashMap data=new HashMap();
        data.put("name",title);
        data.put("pdfUrl",downloadUrl);

        databaseReference.child("Study Material").child(uniqueKey).setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
